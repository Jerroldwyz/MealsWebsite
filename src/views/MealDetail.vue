<template>
  <div class="mx-auto w-[800px]">
    ...
    <div class="grid  grid-cols-1  sm:grid-cols-3 py-2 text-lg">
      ...
      <div>
        ...
        <div class="mt-4">
            ...
            <a 
                :href="meal.strSource" 
                target="_blank" 
                class="ml-3 px-3 py-2 rounded border-2 border-blue-500 bg-blue-600 hover:bg-blue-700 text-white transition-colors" 
            >
